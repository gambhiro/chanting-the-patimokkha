...
\begin{axis}[
    ...
    extra x ticks={2014-06-21,2014-07-11,2014-10-08,2014-11-21},
    extra x tick labels={06-21,Asalha Puja 07-11,Pavarana 10-08,$s = 4.3$: 11-21},
    every axis legend/.append style={ at={(0.99,0.72)}, anchor=north east },
  ...
  \draw[green!40,thick] (axis cs:2014-01-28,24) -- (axis cs:2014-11-21,162);% s = 4.3043 day / page, or 0.2323 page / day
  ...
  \draw
    ...
    node[above right] {$\text{sinking} = \frac{dy}{\frac{1}{2} dx} = 4.3 \frac{\text{day}}{\text{page}}$};

  \draw
    (axis cs:2014-06-01,90) |-
    (axis cs:2014-06-10,100)
    node[near start, left] {$1.84 \frac{\text{d}}{\text{p}}$};
